...
namespace LuaInterface
{
	public class LuaFunction : LuaBaseRef
	{
		...
		{
			this.luaState.Push(n);
			this.argCount++;
		}

		public void Push(uint un)
		{
			this.luaState.Push(un);
			this.argCount++;
		}
		...
		public double CheckNumber()
		{
			...
			try
			{
				result = this.luaState.LuaCheckNumber(this.stackPos++);
			}
			catch (Exception ex)
			{
				this.EndPCall();
		...
		public bool CheckBoolean()
		{
			...
			try
			{
				result = this.luaState.LuaCheckBoolean(this.stackPos++);
			}
			catch (Exception ex)
			{
				this.EndPCall();
		...
		public long CheckLong()
		{
			...
			try
			{
				result = this.luaState.CheckLong(this.stackPos++);
			}
			catch (Exception ex)
			{
				this.EndPCall();
		...
		public ulong CheckULong()
		{
			...
			try
			{
				result = this.luaState.CheckULong(this.stackPos++);
			}
			catch (Exception ex)
			{
				this.EndPCall();
